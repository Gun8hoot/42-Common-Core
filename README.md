...
```sh
git clone --recursive -job 2 git@github.com:Gun8hoot/42-Common-Core.git
```
...
- [So_Long](https://github.com/Gun8hoot/42-Common-Core/blob/main/so_long/README.md) : A simple 2D game who work using the 42 graphical library called minilibx
- [Push_Swap](https://github.com/Gun8hoot/42-Common-Core/blob/main/push_swap/README.md) : Sort an array of number using a two linked list
### CERCLES 3 :
- [Philosophers](https://github.com/Gun8hoot/42-Common-Core/blob/main/philosophers/README.md) : A dining philosophers simulation to discover thread
- [Minishell](https://github.com/thlibers/minishell/blob/e6bf495036357341d79875b132f678cf8b824f0c/README.md) : A "simple" command line interpreter
### CERCLES 4 :
- [Cube3d](https://github.com/Gun8hoot/Cube3D/blob/149acc48027ed98f2ca3e29ef0964372d5ee76d8/README.md) : Render a game using raycasting
- [Netpractice](https://github.com/Gun8hoot/42-Common-Core/blob/main/netpractice/README.md) : Learning game about network
- [Modules_CPP](https://github.com/Gun8hoot/42-Common-Core/blob/main/modules_cpp/README.md) : Learning exercices to know how to coded in C++
### CERCLES 5 :
